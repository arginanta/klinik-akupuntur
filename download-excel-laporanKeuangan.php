...
foreach ($data_finance as $finance) {
    ...
    $sheet->setCellValue('B' . $start, $finance['id_rm'])->getColumnDimension('B')->setAutoSize(true);
    ...
    $sheet->setCellValue('H' . $start, $finance['created_at'])->getColumnDimension('H')->setAutoSize(true);
